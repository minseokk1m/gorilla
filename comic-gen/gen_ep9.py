...
FINAL = os.path.join(BASE, "final_ep9"); KEYF = os.path.join(BASE, "openai_key.txt")
...
PAGES = {
 ...
 "p02":"Two panels, study room. (1 ~55%) NA BAE-UM relaxed, asking JU BON-JIL; JU BON-JIL calm. (2 ~45% close-up) JU BON-JIL with a slight knowing look.",
 ...
 "p06":"Two panels. (1 ~55%) JU BON-JIL turning to the whiteboard to draw two curves; NA BAE-UM ready. (2 ~45%) JU BON-JIL picking up the marker.",
 ...
 "p11":"Two panels. (1 ~55%) JU BON-JIL turning to a bigger point about standard replacement; NA BAE-UM attentive. (2 ~45%) JU BON-JIL serious look.",
 ...
 "p15":"Two panels. (1 ~55%) NA BAE-UM saying even the No.1 gets pushed out when the category changes; JU BON-JIL nodding. (2 ~45%) NA BAE-UM's realization.",
 "p16":"One panel (~100%). A timeline of gorilla replacement across eras with each era's leader icon: 아날로그 → 피처폰 → 스마트폰, and Wintel → Winvidia; each step replacing the last; JU BON-JIL beside.",
 "p17":"Two panels. (1 ~55%) JU BON-JIL explaining each era had its own gorilla; NA BAE-UM noting. (2 ~45%) close on the timeline handoff.",
 "p18":"Two panels. (1 ~55%) NA BAE-UM asking gravely whether the gorilla is safe; JU BON-JIL raising a finger. (2 ~45%) JU BON-JIL serious close-up.",
 "p19":"One panel (~100%). A dramatic image: a category dying and the gorilla fading away with it in silhouette; ominous.",
 "p20":"Two panels. (1 ~55%) JU BON-JIL stating that when the category dies, the gorilla dies; NA BAE-UM absorbing. (2 ~45%) NA BAE-UM's sober face.",
 ...
 "p26":"Two panels. (1 ~55%) JU BON-JIL noting the selling rule will come in a later season; NA BAE-UM nodding. (2 ~45%) JU BON-JIL knowing look.",
...
BANDS = {
 ...
 "p12":'윈텔(Windows+Intel) 40년 지배 → 이른바 윈비디아(Windows+NVIDIA) 시대 · 인텔=모토롤라·노키아처럼 과거 고릴라',

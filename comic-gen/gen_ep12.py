...
PAGES = {
 ...
 "p19":"Two panels. (1 ~55%) JU BON-JIL tapping the red fifth row; NA BAE-UM nodding. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear; the thought balloon belongs to NA BAE-UM.",
 "p20":"Two panels. (1 ~55%) JU BON-JIL handing NA BAE-UM two blank index cards; NA BAE-UM taking them, determined. (2 ~45%) NA BAE-UM at the whiteboard for the first time this season, marker in hand, the five-row table behind him (as specified on p18, all labels intact).",
 "p21":"One panel (~100%). The five-row table on the whiteboard (same labels as p18) now with a column of hand-drawn marks added at the far right under a small header 'HBM': five check marks in the '골짜기 건넘' side; NA BAE-UM presenting with the marker, JU BON-JIL watching; ONLY the table labels, the header 'HBM' and check marks.",
 "p22":"Two panels. (1 ~55%) NA BAE-UM explaining HBM row by row, confident; HAN SIL-SOK nodding. (2 ~45%) JU BON-JIL's approving face.",
 "p23":"One panel (~100%). The same five-row table with a second column at the far right under a small header '탕수의 종목': five X marks on the '초기시장' side; NA BAE-UM presenting, HAN TANG-SU sinking in his chair; ONLY the table labels, the two headers 'HBM' and '탕수의 종목', check and X marks.",

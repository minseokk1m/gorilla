...
PAGES = {
 ...
 "p04":"Two panels. (1 ~55%) JU BON-JIL explaining the cake and pointing at tier 2; NA BAE-UM following. (2 ~45%) close on the highlighted Chips tier. The cake tiers show EXACTLY the same five labels as the previous page: ① Energy ② Chips / Compute ③ Infrastructure ④ Models ⑤ Applications — do NOT invent Silicon, DRAM or Storage as tier labels.",
 ...
 "p08":"One panel (~100%). NA BAE-UM presenting at the whiteboard, beside him a stacked HBM chip illustration with a 'Tornado' label and arrows: SK Hynix leading, Samsung and Micron chasing, AI big-tech buying it all; confident. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak.",
 "p09":"Two panels. (1 ~55%) NA BAE-UM explaining HBM as high-bandwidth memory stacked on AI GPUs; members nodding. (2 ~45%) close on the stacked HBM chip. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak.",
 "p10":"Two panels. (1 ~55%) NA BAE-UM pointing at the buying arrows; JU BON-JIL giving a small approving check mark. (2 ~45%) JU BON-JIL's small satisfied nod. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak.",
 ...
 "p13":"One panel (~100%). A DRAM illustration (PC/server standard memory) with a stable high plateau curve; a clean label 'DRAM = Main Street'; NA BAE-UM presenting it. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak.",
 "p14":"Two panels. (1 ~55%) NA BAE-UM explaining DRAM as a 30-year mature category, a Samsung+SK duopoly; members noting. (2 ~45%) close on the stable plateau curve. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak. Panel 2 is a close-up of the stable plateau curve on the board (no people).",
 "p15":"One panel (~100%). An SSD pushing out HDD illustration, SSD share rising with arrows; a clean label 'NAND/SSD = Main Street 진입 중'; NA BAE-UM presenting. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak.",
 "p16":"Two panels. (1 ~55%) NA BAE-UM explaining SSD nearly replacing HDD, moving from late tornado into main street; members following. (2 ~45%) close on the SSD-vs-HDD share arrows. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak.",
 "p17":"One panel (~100%). An HDD illustration (Seagate, WD) with a declining downward curve in a sunset tone; a clean label 'HDD = Declining'; NA BAE-UM presenting. CRITICAL: NA BAE-UM (late-30s, plain black hair, NO glasses, charcoal shirt) is the ONLY person standing at the whiteboard and the ONLY speaker of the presentation line; JU BON-JIL sits among the members listening and must NOT stand at the board or speak.",
 "p18":"Two panels. (1 ~55%) NA BAE-UM explaining HDD makers yielding to SSD; JU BON-JIL adding a grave voice-over point. (2 ~45%) the declining HDD curve close-up. Panel 1: NA BAE-UM at the board speaks the polite line; JU BON-JIL seated. Panel 2: JU BON-JIL speaks the grave line, seated, balloon tail to JU BON-JIL. ABSOLUTE RULE: in panel 1 the person standing and speaking is NA BAE-UM (BLACK hair, NO glasses, charcoal shirt) — if a grey-haired man appears standing at the board this image is WRONG; JU BON-JIL sits at the table and speaks ONLY the panel-2 line while seated.",
 ...
 "p20":"Two panels. (1 ~55%) NA BAE-UM connecting all the stages, the picture forming. (2 ~45%) NA BAE-UM's understanding face. The whiteboard behind is completely BLANK (nothing written).",
 ...
 "p22":"One panel (~100%). A whiteboard CROSS diagram: a <DRAM cycle> curve with an <HBM cycle> curve rising up and crossing over it with arrows; a clean label noting standard memory swaps 1·2·3 ranks while HBM's high switching cost keeps the leader stable; HAN SIL-SOK pointing. CRITICAL: HAN SIL-SOK (40s, BLACK hair, thin metal glasses, knit VEST over a neat shirt) is the presenter at the whiteboard and the ONLY speaker; JU BON-JIL must NOT appear at the whiteboard.",
 "p23":"Two panels. (1 ~55%) HAN SIL-SOK explaining the cross and HBM's stickiness; NA BAE-UM intent. (2 ~45%) close on the crossing curves. CRITICAL: HAN SIL-SOK (40s, BLACK hair, thin metal glasses, knit VEST over a neat shirt) is the presenter at the whiteboard and the ONLY speaker; JU BON-JIL must NOT appear at the whiteboard.",
 "p23b":"One split panel (~100%), LEFT vs RIGHT contrast of two jungles. LEFT half (deep green): one massive calm gorilla on a high rock, a wide deep moat around it, label box inside left half '고릴라 게임 · 전환비용 큰 정글'. RIGHT half (lighter tone): three similar-sized lions circling a rotating crown on a pedestal, label box inside right half '킹덤 게임 · 전환비용 작은 정글'. A bold VS badge center, webtoon ink tone. Render every Korean word with perfect spelling — especially '표준' and '가깝다' exactly as given.",
 "p24":"One panel (~100%). A Samsung-Electronics-style single logo at top, with FOUR arrows branching down to four categories (HBM, DRAM, NAND, HDD), each arrow ending in a different stage label (Tornado / Main Street / 진입 / Declining); NA BAE-UM pointing. Balloon 1 belongs to NA BAE-UM pointing at the board; balloon 2 ALSO belongs to NA BAE-UM (his realization); HAN TANG-SU (red cap) must NOT speak on this page. ABSOLUTE RULE: the ONLY speaker on this page is NA BAE-UM (BLACK hair, NO glasses, charcoal shirt) standing at the board; BOTH balloons attach to him; the grey-haired mentor sits silent among listeners.",
 ...
 "p28c":"One panel (~100%). The whiteboard: a hand-drawn card titled '분기 점검표' with four numbered boxes in a row labeled exactly '① 채택 위치', '② 기대 위치', '③ 등급', '④ 신호'; inside box ① NA BAE-UM has hand-written ONLY the word '토네이도' with a tiny memory-chip doodle; boxes ②, ③ and ④ are EMPTY except for one small question mark each; NA BAE-UM at the board holding the marker, JU BON-JIL beside him; ONLY these labels.",
 "p28d":"Two panels. (1 ~55%) NA BAE-UM standing at the whiteboard staring at the three empty question-mark boxes of the '분기 점검표' card (labels '① 채택 위치', '② 기대 위치', '③ 등급', '④ 신호', box ① holding ONLY the word '토네이도'), marker hovering, a little lost; JU BON-JIL beside him with a patient smile; the table is completely BARE (NO paper cards, NO notes, NO extra writing anywhere). (2 ~45%) close on JU BON-JIL's warm face, one finger up; plain background.",
...
DLG = {
 ...
 "p28b":[(1,'C','speech','지도에서 두 칸을 채웠어\n법칙과 사례\n다음 시즌은 그걸 돈과 연결하는 시간이야'),
        (1,'C','narr','① ② 시즌 1 끝\n③ ④ 시즌 2')],
 "p28c":[(1,'C','label','분기 점검표'),(1,'C','label','① 채택 위치'),(1,'C','label','② 기대 위치'),(1,'C','label','③ 등급'),(1,'C','label','④ 신호'),
        (1,'C','speech','나배움: 실전은 어떻게 생겼는데요?'),
        (1,'C','speech','주본질: 이 표 한 장이야, 분기에 한 번 네 칸을 채우는 것\n첫 칸은 오늘 시험으로 이미 채웠지')],
 "p28d":[(1,'C','think','나배움: 나머지 세 칸은 아직 뭔지도 모르겠다'),
        (2,'C','speech','주본질: 그 세 칸을 채우는 게 시즌 2야\n기대, 등급, 신호\n다 채우면 네 손으로 사냥할 수 있어')],
...
NOTES = {
 ...
 "p28c":'해설: 분기 점검표는 시즌 2 마지막에 완성되는 ④실전의 도구다. ① 채택 위치는 시즌 1의 판별표(초기시장·캐즘·토네이도·중심가)로 채우고, ② 기대 위치·③ 등급·④ 신호는 시즌 2에서 배운다. 학습 지도 ④의 맛보기',

...
PAGES = {
 ...
 "p19":"Two panels. (1 ~55%) JU BON-JIL emphasizing the category-death point; NA BAE-UM sober. (2 ~45%) JU BON-JIL serious close-up.",
 ...
 "p26":"Two panels. (1 ~55%) JU BON-JIL making the key takeaway with a finger raised; NA BAE-UM noting. (2 ~45%) JU BON-JIL emphatic close-up.",

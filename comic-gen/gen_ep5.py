...
PAGES = {
 ...
 "p18":"Two panels. (1 ~55%) NA BAE-UM summarizing while pointing at the whiteboard pins; JU BON-JIL nodding in an inset. (2 ~45%) JU BON-JIL's approving nod close-up.",
 "p19":"Two panels. (1 ~55%) JU BON-JIL adding the investor angle, calm and clear; NA BAE-UM taking notes. (2 ~45%) JU BON-JIL confident close-up.",
 ...
 "p27":"Two panels. (1 ~55%) JU BON-JIL turning serious-hopeful, gesturing at the standing pins; NA BAE-UM attentive. (2 ~45%) JU BON-JIL's steady look.",

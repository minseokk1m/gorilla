...
CHARS = (
    ...
    "GU BON-JIL (mentor) late-40s, fit, neat salt-and-pepper short hair, thin metal-rim glasses, "
...
SHEET_PROMPT = (
    ...
    "LEFT, GU BON-JIL, late-40s mentor, dignified and fit, neat salt-and-pepper short hair with "
...
PAGES = {
 ...
 "p26":"Two panels, warm desk light. (1 ~60%, over-the-shoulder) NA BAE-UM writing two neat lines in his open notebook (leave the written lines BLANK for later lettering), with small hand-drawn underlines and a star; GU BON-JIL in the soft background nodding warmly; empty speech balloon. (2 ~40%) a clean close-up of the notebook page, the two lines left blank, a small star and a tiny doodle of a gorilla in the corner.",
 "p27":"Two panels, bright study room. (1 ~52%) NA BAE-UM holds up his smartphone showing a blurred mosaic of Korean stock-YouTube thumbnails (no readable text), asking earnestly; GU BON-JIL listens with a patient knowing smile; empty speech balloon. (2 ~48%) GU BON-JIL gently shakes his head and raises a finger to correct a common myth, calm and clear; empty speech balloon.",
 ...
 "p29":"Two panels, bright crisp whiteboard. (1 ~58%) GU BON-JIL gestures toward three simple clean hand-drawn icons in a row: a calendar with only a couple of marks, an office worker with a laptop, and a fund-manager figure with an X crossed over it; NA BAE-UM notes each; empty speech balloon. (2 ~42%) NA BAE-UM counting the three points off on his fingers, ideas clicking into place, a small confident smile; empty thought balloon.",
 "p30":"A bold emphasis panel with a small reaction strip. MAIN PANEL (~70%): a strong confident composition, GU BON-JIL pointing firmly at NA BAE-UM, behind them a bold empty mustard-yellow typographic banner space; warm assured lighting; empty speech balloon. BOTTOM STRIP (~30%): a close-up of NA BAE-UM, resolved and quietly emotional; empty narration box.",
 "p31":"Two panels, deadpan comedic contrast. (1 ~55%) HAN TANG-SU springs to his feet, red cap, waving his smartphone whose screen shows a blurred '2x leverage' buy interface, eyes shining with reckless confidence, comic speed-lines; the other members lean back warily; empty speech balloon. (2 ~45%) GU BON-JIL stays calm with a dry knowing look, slowly shaking his head; NA BAE-UM beside, half-amused half-worried, palm to his forehead; two empty speech balloons.",
 "p32":"Two panels. (1 ~50% close-up) GU BON-JIL's calm but serious face delivering a quiet warning, eyes steady and grave; subdued warm light; empty speech balloon. (2 ~50%) HAN TANG-SU pauses for a split second, then shrugs it off with a careless dismissive grin (foreshadowing he won't listen); empty speech balloon.",
 ...
 "p35":"Three panels. (1 ~30%) GU BON-JIL bathed in warm light with a knowing smile, his hand pointing toward the reader, behind him a bold empty mustard typographic space; empty speech balloon. (2 ~22%) NA BAE-UM straightening with new resolve, notebook in hand; empty speech balloon. (3 ~48%) behind GU BON-JIL the scene dissolves into a sepia-toned 1943 Iowa cornfield with two farmers and a faint hand-drawn bell-shaped adoption curve overlaid across the sky; nostalgic time-blend; a black caption band across the very bottom left EMPTY for a next-episode preview.",
}

...
PAGES = {
 ...
 "p08":"Two panels, still INSIDE the cafe 브릿지 커피 (round wooden cafe table, window, hanging lamps; NO whiteboard, NO bookshelves). (1 ~55%) HAN TANG-SU (red cap, mustard hoodie) bursts in holding his phone with a hot-stock ranking screen (the list rows are blurred/abstract shapes, NO readable stock names), grinning wide; the two friends turn. EXACTLY FOUR people in this scene: HAN TANG-SU, NA BAE-UM, AN JEONG-MAN (BLACK hair, round glasses, late-30s), GO SEONG-JANG (BLACK hair, blue shirt, late-30s); NO other person, NO gray-haired or older man anywhere. (2 ~45%) all three friends now point at NA BAE-UM from three directions, each holding their prop (book / tablet / phone); NA BAE-UM cornered, dizzy spiral eyes, comic style; the same FOUR people only, no gray-haired man.",

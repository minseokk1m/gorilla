...
PAGES = {
 ...
 "p02":"A calm magazine-style intro page, warm beige background, webtoon-friendly flat illustration, three stacked panels with white gutters. (1 ~40%) a tidy desk seen from above: a worn notebook, a phone showing a falling red stock chart, and the book 'The Gorilla Game'. (2 ~30%) anonymous flat gray silhouettes of ordinary commuters on a subway (NO recognizable characters, no red cap, no known faces), only one figure (NA BAE-UM) highlighted in warm color. (3 ~30%) a simple warm illustration of a plain wooden door ajar with warm light leaking out; the door has NO sign, NO plate, NO text.",
 "p03":"Two panels, prologue hook. (1 ~60%) a bright cafe window seat in the morning; NA BAE-UM (39) smiles softly showing his phone screen with a green +28.02% yearly return chart; on the table the book with its cover clearly reading only 'The Gorilla Game' (English title, gorilla silhouette) and a closed notebook. (2 ~40%) close on the phone screen: +28.02%, five trade marks on a one-year chart.",
 ...
 "p07":"Two panels, comedy beat. (1 ~55%) INSIDE the cozy cafe '브릿지 커피' (round wooden cafe table, window light, hanging lamps; this is a CAFE, no whiteboard, no bookshelf wall): VALUE friend AN JEONG-MAN (round glasses, navy cardigan, thick finance book) and GROWTH friend GO SEONG-JANG (blue shirt, tablet with rising revenue chart) leaning toward each other arguing, sparks between their eyes, NA BAE-UM between them shrinking. (2 ~45%) the two friends nose to nose, comically intense, NA BAE-UM's sweat drop.",
 "p08":"Two panels, still INSIDE the cafe 브릿지 커피 (round wooden cafe table, window, hanging lamps; NO whiteboard, NO bookshelves). (1 ~55%) HAN TANG-SU (red cap, mustard hoodie) bursts in holding his phone with a hot-stock ranking screen (the list rows are blurred/abstract shapes, NO readable stock names), grinning wide; the two friends turn — AN JEONG-MAN has BLACK hair and a late-30s face (NOT gray, NOT old), GO SEONG-JANG also late-30s black hair. (2 ~45%) all three friends now point at NA BAE-UM from three directions, each holding their prop (book / tablet / phone); NA BAE-UM cornered, dizzy spiral eyes, comic style.",
 "p09":"Two panels. (1 ~55%) still inside the cafe: NA BAE-UM alone at the cafe table after the friends left (empty coffee cups remain, the table notebook CLOSED and blank), lightbulb moment, a naive bright face. (2 ~45%) close-up of NA BAE-UM's confident naive grin; a dark ironic narration box sits at the panel bottom.",
 ...
 "p12":"Two panels, cool tone. (1 ~55%) a dark professional trading floor seen from behind: rows of fund managers, six-monitor desks, glowing charts and order books, one silhouette turning slightly. (2 ~45%) a server room with racks and blinking lights and an abstract stream of glowing digits only (NO charts, NO flowcharts, NO logos, NO company names, NO readable words anywhere), suggesting algorithmic quant trading; cold blue light; keep inked webtoon linework, NOT photoreal.",
 "p13":"Two panels, transition back to warm tone. (1 ~55%) evening neighborhood bookstore, warm light; NA BAE-UM wandering into the shelves, deflated posture; every book spine on the shelves is textless (plain colored spines, NO titles). (2 ~45%) his hand pulling one book from the shelf: cover reads 'The Gorilla Game' with a gorilla silhouette; his eyes slightly widening.",
 "p14":"Two panels. (1 ~55%) still in the bookstore aisle (shelves of textless book spines behind): NA BAE-UM reading the book's back cover; an inset shows a small printed card tucked in the book: 'GORILLA HUNTERS investment study' with a simple map mark. (2 ~45%) NA BAE-UM on the street at night holding the card, hesitant but curious, streetlight halo.",
 ...
 "p26":"One large panel (~100%). The whiteboard with a hand-drawn 'AI 표준 전쟁' map: THREE big circles labeled 'NVIDIA · CUDA', '구글 · TPU', '테슬라 · FSD', arrows between them clashing at a center marked '표준?'; below the three circles, one smaller rising circle labeled 'AMD · Helios' with a small upward arrow toward the big three. JU BON-JIL presenting, members watching. Render these diagram labels cleanly and exactly as specified (NVIDIA · CUDA / 구글 · TPU / 테슬라 · FSD / AMD · Helios / 표준?); these labels belong ONLY inside this diagram.",
 "p27":"Two panels. (1 ~55%) JU BON-JIL calm and firm, marker lowered, delivering the caution; the whiteboard behind him is heavily out of focus with only vague circle shapes (NO readable labels). (2 ~45%) NA BAE-UM writing in his notebook, thoughtful; the notebook shows ONLY the two specified hand-written lines.",
 ...
 "p30":"Two panels. (1 ~55%) NA BAE-UM holding up his phone showing a blurred generic video app grid (thumbnails abstract, NO readable titles), asking his honest question; the whiteboard in the background is completely BLANK. (2 ~45%) JU BON-JIL amused, not offended, leaning back with arms crossed.",
 ...
 "p36":"Two panels, quiet night ending. (1 ~55%) the study room after everyone left, warm lamp; NA BAE-UM alone, holding the book 'The Gorilla Game' against his chest, looking at the whiteboard which shows only faint half-erased traces of today's staircase and 3x3 grid sketches (NO readable words); the book cover reads ONLY the ENGLISH title 'The Gorilla Game' (never Korean). (2 ~45%) close on his tired but clear eyes reflecting the whiteboard light.",
 "p37":"Two panels, closing. (1 ~55%) JU BON-JIL at the door turning back with a warm smile, pointing lightly at NA BAE-UM (and through him, at the reader). (2 ~45%) a faint dreamy background image drawn in webtoon ink style: a golden Iowa cornfield at dusk with ONE plain faint bell-curve line floating over it (a bare line, NO labels, NO segment names, NO text on or near the curve); a black caption band across the very bottom.",
}

...
FOURCARD = ("a hand-drawn four-row card titled '고릴라 4기준' with rows exactly: '자체 아키텍처 → O' / '전환비용 → X' / '네트워크 효과 → X' / '완전완비제품 → X'; a small tally at the bottom reading ONLY '1 / 4'")
TESLADIAG = ("a car icon at the top labeled 'Tesla'; two arrows down to two canyon sketches labeled '전기차 · 캐즘' and '자율주행 · 캐즘'; under the first canyon three tiny icons (a charging plug, a flame, a road) with NO text; under the second canyon a tiny steering wheel with a question mark")
...
LOCK_NB = "ABSOLUTE RULE: the presenter standing at the whiteboard holding the marker is NA BAE-UM (late-30s, short BLACK hair, NO glasses, charcoal button shirt) and the speech balloon tail points at HIM; JU BON-JIL (grey hair, glasses, navy knit) sits or stands aside and does NOT present (a grey-haired man at the board would be WRONG). "
...
PAGES = {
 ...
 "p04":f"One panel (~100%). The whiteboard shows {TESLADIAG}; JU BON-JIL to the side; ONLY these three labels.",
 "p05":f"Two panels. (1 ~55%) JU BON-JIL beside the whiteboard which shows {TESLADIAG}, recalling Ep3 with a small inset of a canyon sketch with a car fallen in (no text); NA BAE-UM nodding. (2 ~45%) NA BAE-UM (black hair, no glasses, charcoal shirt) insisting, pointing at his phone (blurred shape), the balloon tail pointing at him; plain background.",
 "p06":f"One panel (~100%). A street scene {INK}(no readable text, no logos): a sleek generic electric sedan with an EMPTY driver seat gliding past a sunny downtown corner, a few anonymous pedestrians staring, one filming with a phone; a small clean label box: '2026 · 무감독 로보택시'.",
 ...
 "p08":f"One panel (~100%). {LOCK_NB}The whiteboard shows {TABLE5}; a far-right column headed '자율주행' with marks: row 1 a small circled '?', row 2 a check on the '초기시장' side, row 3 a check on the '초기시장' side, row 4 a check on the '초기시장' side, row 5 a check on the '초기시장' side; NA BAE-UM presenting; ONLY these labels and marks.",
 "p09":f"Two panels. (1 ~55%) {LOCK_NB}NA BAE-UM at the board explaining row one with a torn expression; the whiteboard shows {TABLE5} with an EXTRA fourth column at the far right headed '자율주행' whose five cells contain, top to bottom: a circled '?', a check mark, a check mark, a check mark, a check mark (all marks INSIDE that far-right '자율주행' column only; the '초기시장' and '골짜기 건넘' columns contain ONLY their text, NO check marks); JU BON-JIL listening from the table. (2 ~45%) HAN SIL-SOK (knit vest, glasses) speaking up from the table, calm, the balloon tail pointing at him; plain background.",
 "p10":"Two panels. (1 ~55%) JU BON-JIL summing up beside the whiteboard which is out of focus with no readable text; NA BAE-UM nodding slowly. (2 ~45%) the notebook close-up: ONLY these hand-written lines: '자율주행: 건너는 중, 아직 안 건넘' / '참조사례가 도시마다 쌓이기 시작'.",
 ...
 "p12":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY a small charging-plug sketch labeled 'NACS' with three tiny generic car icons queuing toward it; NA BAE-UM's eyes widening. (2 ~45%) JU BON-JIL drawing ONLY a small vertical stack of four blocks on the board with tiny icons (a chip, a battery, a plug, a server) and NO words.",
 "p13":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY a small vertical stack of four blocks with tiny icons (a chip, a battery, a plug, a server) and NO words; HAN SIL-SOK nodding. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear; the thought balloon belongs to NA BAE-UM.",
 ...
 "p15":"Two panels. (1 ~55%) JU BON-JIL delivering the stance beside the whiteboard which shows ONLY the luggage tag labeled '캐즘 위치의 고릴라 후보' tied to a small car icon and the basket sketch labeled '바구니에 담고 관찰'; NA BAE-UM writing. (2 ~45%) the notebook close-up: ONLY these hand-written lines: '고릴라가 아니다가 아니라 아직 아니다' / '배제가 아니라 바구니 관찰'.",
 ...
 "p18":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY the egg labeled '잠재 고릴라', three cloud sketches labeled '파운데이션 모델 A', '파운데이션 모델 B', '파운데이션 모델 C' and arrows to a small tornado sketch; NA BAE-UM noting silently (NA BAE-UM has NO balloon on this page; exactly ONE speech balloon in panel 1, JU BON-JIL's; do NOT add any reply balloon). (2 ~45%) HAN TANG-SU (red cap) bursting in with a question, eyes gleaming.",
 ...
 "p20":"Two panels. (1 ~55%) JU BON-JIL firm, pointing at the red X on the whiteboard which shows ONLY the simple 3x3 grid with the center cell shaded mustard with a star, a small 'VC' label in the top-right cell and a red X over an arrow from center to top-right; HAN TANG-SU deflating. (2 ~45%) NA BAE-UM's notebook close-up: ONLY these hand-written lines: '비상장 초기 단계는 정중앙의 자리가 아니다' / '살 수 있는 토네이도만 우리 게임'.",
 ...
 "p22":f"One panel (~100%). The whiteboard shows {FOURCARD}; JU BON-JIL presenting; ONLY these labels.",
 "p23":f"Two panels. (1 ~55%) JU BON-JIL explaining each X beside the whiteboard which shows {FOURCARD}; NA BAE-UM sober. (2 ~45%) close on the same card ({FOURCARD}) as JU BON-JIL draws a small chimp sketch next to the tally (no new text).",
 ...
 "p25":f"Two panels. (1 ~55%) JU BON-JIL summing up beside the whiteboard which shows {FOURCARD} with a small chimp sketch beside the tally; HAN TANG-SU nodding grimly. (2 ~45%) the notebook close-up: ONLY these hand-written lines: '4기준 1/4 = 침팬지급' / '상장 후 흐름은 하입의 증거' / '본 매수 대상이 아니다'.",
 ...
 "p28":"Two panels. (1 ~55%) JU BON-JIL closing part ③ of the roadmap beside the whiteboard which shows ONLY the LEARNING ROADMAP with boxes '① 기술수용주기 이해', '② 사례로 익히기', '③ 투자와 연결', '④ 실전', with ①②③ each carrying a green check; NA BAE-UM moved. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear; the thought balloon belongs to NA BAE-UM.",
 "p29":"Two panels. (1 ~60%, over-the-shoulder) NA BAE-UM writing the summary; JU BON-JIL in the soft background; the whiteboard behind is completely BLANK (no writing of any kind). (2 ~40%) the notebook close-up: ONLY these hand-written lines: '두 분야 결합체는 둘 다 건너야 한다' / '비상장 초기는 우리 자리가 아니다' / '4기준으로 도전자를 심사한다'.",
 "p30":"Two panels, quiet beat. (1 ~60%) evening, NA BAE-UM looking at the whiteboard which shows ONLY the LEARNING ROADMAP boxes '① 기술수용주기 이해', '② 사례로 익히기', '③ 투자와 연결', '④ 실전' with green checks on ①②③, the others leaving. (2 ~40%) NA BAE-UM's face, a mix of pride and a new question.",
 "p31":f"Two panels. (1 ~55%) at the door NA BAE-UM (black hair, no glasses, charcoal shirt) asks JU BON-JIL a practical question, the balloon tail pointing at NA BAE-UM; JU BON-JIL smiles; the whiteboard behind is completely BLANK. (2 ~45%) a faint dreamy image {INK} a plain notebook labeled ONLY '사냥 일지' on a desk with a calendar showing four circled marks in a year (no other text).",
 "p32":f"One panel (~100%). Closing chapter-end, {INK}the canyon and the egg behind, a desk with a notebook ahead; NA BAE-UM and JU BON-JIL small figures; the top of the page has NO band and NO text box; a solid BLACK caption band runs across the very BOTTOM edge of the page (bottom 10%), and THE ONLY TEXT ON THIS ENTIRE PAGE is the specified caption lettered in white INSIDE that bottom black band, centered; do NOT invent any other sentence anywhere.",
}
...
BANDS = {
 ...
 "p19":'비상장 초기 단계는 3×3의 오른쪽 위(VC)의 자리 · 정중앙(개인 투자자)의 자리가 아니다 · 살 수 있는 토네이도만 우리 게임',

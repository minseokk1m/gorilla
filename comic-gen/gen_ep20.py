...
PAGES = {
 ...
 "p18":f"One panel (~100%). {LOCK_HS}The whiteboard shows {G6}; all cells EMPTY, waiting for cards; ONLY these labels.",
 "p19":f"One panel (~100%). {LOCK_HS}The whiteboard shows {G6} with small paper cards now pinned in cells, each card bearing ONLY a company name: in the '고릴라' cell the cards 'NVIDIA', 'ASML', 'TSMC', 'ARM'; in the '침팬지' cell 'AMD'; in the '위치 라벨' box 'Tesla'; HAN SIL-SOK pinning the last card; ONLY these labels and names.",
 "p20":f"One panel (~100%). {LOCK_HS}The whiteboard shows {G6} with the cards from before ('NVIDIA', 'ASML', 'TSMC', 'ARM' in '고릴라'; 'AMD' in '침팬지'; 'Tesla' in the '위치 라벨' box) and more cards: in the '영주' cell 'Oracle'; in the '원숭이' cell three cards 'SanDisk', 'WDC', 'Seagate'; a card 'SK하이닉스' placed on the line between '고릴라' and '영주' with a small hand-drawn arrow pointing both ways; HAN SIL-SOK explaining; ONLY these labels and names.",
 "p21":f"Two panels. (1 ~55%) {LOCK_HS}HAN SIL-SOK explaining beside the whiteboard which shows {G6} with all the pinned company cards and the 'SK하이닉스' card on the line between '고릴라' and '영주'; NA BAE-UM nodding. (2 ~45%) AN MID-EO raising the objection hand, the group turning with mock dread.",

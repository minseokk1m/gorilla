...
BASE = os.path.expanduser("~/Desktop/고릴라헌터스_EP6")
...
RULES_TEXT = (
    ...
    "(ChatGPT, NVIDIA, GPU, HBM, charts) cleanly and correctly when specified.")
...
PAGES = {
 ...
 "p02":"Two panels, study room. (1 ~55%) NA BAE-UM asking GU BON-JIL what comes when all the bowling pins finally fall; GU BON-JIL calm. (2 ~45% close-up) GU BON-JIL with a knowing look, about to explain the storm.",
 ...
 "p11":"Two panels. (1 ~55%) GU BON-JIL explaining that AI big-tech bought all of it; NA BAE-UM amazed. (2 ~45%) close on the steep non-linear part of the curve.",
 "p12":"Two panels. (1 ~55%) NA BAE-UM pointing at the soaring chart, astonished. (2 ~45%) NA BAE-UM's amazed close-up.",
 "p13":"Two panels. (1 ~55%) GU BON-JIL raising a finger to mark an important principle; NA BAE-UM ready to note. (2 ~45%) GU BON-JIL serious teaching look.",
 "p14":"One panel (~100%). A whiteboard with TWO labeled rows for buy-timing: '응용 소프트웨어 → 볼링앨리부터' and '지원 하드웨어(칩·메모리) → 토네이도 형성 후'; NVIDIA and HBM icons placed in the 'after tornado' row; GU BON-JIL beside.",
 "p15":"Two panels. (1 ~55%) GU BON-JIL explaining that timing differs by category type; NA BAE-UM nodding. (2 ~45%) NA BAE-UM's focused face.",
 ...
 "p17":"Two panels. (1 ~55%) NA BAE-UM raising his hand to ask how to detect tornado entry; GU BON-JIL smiling. (2 ~45%) GU BON-JIL pointing at a chart.",
 "p18":"Two panels. (1 ~55%) GU BON-JIL pointing at a non-linear accelerating revenue curve; NA BAE-UM watching. (2 ~45%) close on the accelerating curve.",
 "p19":"Two panels. (1 ~55%) GU BON-JIL making the detection point clearly; NA BAE-UM noting. (2 ~45%) GU BON-JIL confident close-up.",
 ...
 "p23":"Two panels. (1 ~60%, over-the-shoulder) NA BAE-UM writing a clean summary line; GU BON-JIL nodding in the background. (2 ~40%) the notebook close-up with a tornado-and-bridge doodle.",
 ...
 "p27":"Two panels. (1 ~55%) GU BON-JIL turning toward the crowd idea, a knowing smile; NA BAE-UM curious. (2 ~45%) the crowd silhouette in the background.",
 "p28":"Two panels. (1 ~55%) GU BON-JIL delivering the cliffhanger about herd psychology; NA BAE-UM listening. (2 ~45%) the crowd rushing one way, stronger.",
 "p29":"One panel (~100%). The crowd surging toward one direction with GU BON-JIL's small silhouette watching; dramatic.",
 "p30":"One panel (~100%). Closing chapter-end: the herd crowd silhouette; NA BAE-UM and GU BON-JIL small figures; reserve a black caption band across the very bottom for the next-episode preview.",
}

...
PAGES = {
 ...
 "p06":"Two panels. (1 ~55%) JU BON-JIL making the key point that this is the tornado, gesturing; NA BAE-UM nodding. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear in this panel; the thought balloon belongs to NA BAE-UM.",
 ...
 "p13":"Two panels. (1 ~55%) JU BON-JIL raising a finger to mark an important principle; NA BAE-UM ready to note. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear in this panel; the thought balloon belongs to NA BAE-UM.",
 ...
 "p19":"Two panels. (1 ~55%) JU BON-JIL making the detection point clearly; NA BAE-UM noting. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear in this panel; the thought balloon belongs to NA BAE-UM.",

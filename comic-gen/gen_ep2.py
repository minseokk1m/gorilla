...
PAGES = {
 ...
 "p02":"Two panels, study room continuing from last episode. (1 ~55%) NA BAE-UM leaning forward earnest, asking JU BON-JIL; JU BON-JIL calm with a knowing smile, marker in hand; warm light. (2 ~45% close-up) JU BON-JIL's confident eyes, raising one finger as he begins a story.",
 "p03":"Two panels. (1 ~50%) JU BON-JIL at the whiteboard gesturing widely, beginning to tell a story; NA BAE-UM and a couple of study members listening, intrigued. (2 ~50%) a faint dreamy transition, the room edges dissolving toward a warm sepia memory.",
 ...
 "p06":"Two panels, transition from sepia back to present. (1 ~50%) split: left sepia cornfield fading, right a modern smartphone with a glowing AI chat app; an arrow connecting corn to AI, suggesting the same pattern. (2 ~50%) JU BON-JIL in the present study room, warm, explaining that Rogers organized this into a law.",
 "p07":"Two panels. (1 ~60%) JU BON-JIL side view at the clean whiteboard beginning to draw a large smooth BELL-SHAPED curve with a marker; NA BAE-UM copying into his notebook. (2 ~40%) close-up of the marker tracing the bell curve on the white whiteboard.",
 "p08":"One large panel (~100%). The finished bell-shaped TALC curve on the whiteboard, divided into FIVE colored segments left to right with clean English/Korean labels: 기술애호가 2.5% (purple), 선각수용자 13.5% (blue), then a RED dashed vertical line labeled CHASM, 실용주의자 34% (green), 보수주의자 34% (orange), 회의론자 16% (gray); JU BON-JIL standing beside pointing, NA BAE-UM noting. Clean infographic, bright whiteboard.",
 ...
 "p14":"One wide panel (~100%). The full bell curve with ALL FIVE cameo characters standing at their positions along it (CHOI SHIN-SANG, GO BI-JEON, then the chasm, HAN SIL-SOK, SHIN JUNG-HAE, AN MIT-EO); JU BON-JIL presenting the whole picture, NA BAE-UM impressed; clean colorful infographic with characters.",
 "p15":"Two panels. (1 ~55%) NA BAE-UM looking up from his notes, raising a question, a bit puzzled. (2 ~45%) JU BON-JIL smiling, holding up two fingers, about to give two conditions.",
 "p16":"Two panels, condition ONE. (1 ~55%) a bright glowing ChatGPT-style AI chat screen appears like the birth of a new category, arrows merging '대화·문서·코드' into one; JU BON-JIL gesturing to it. (2 ~45%) NA BAE-UM leaning in, intrigued.",
 ...
 "p18":"Two panels. (1 ~55%) JU BON-JIL at the whiteboard explaining, pointing between the two sides, serious; NA BAE-UM nodding. (2 ~45%) NA BAE-UM's dawning understanding close-up.",
 ...
 "p21":"Two panels. (1 ~55%) JU BON-JIL firm and clear, contrasting the two: real pain solved vs no real pain; NA BAE-UM absorbing it. (2 ~45%) JU BON-JIL's emphatic look, finger raised.",
 ...
 "p25":"Two panels. (1 ~55%) NA BAE-UM looking up from the checklist with a wry self-aware half-smile, the penny dropping; JU BON-JIL nodding warmly in the soft background. (2 ~45%) NA BAE-UM close-up, rueful but a little wiser.",
 ...
 "p27":"Two panels, tone darkening. (1 ~55%) the study room lights dim; JU BON-JIL turns serious, pointing a finger up into the air as if naming something. (2 ~45%) NA BAE-UM looking up, curious and a little uneasy.",
 "p28":"One dramatic panel (~100%). A huge word 'CHASM 캐즘' rises in the dark as a cracked, splitting canyon/valley; a small electric car (BEV) silhouette dangles at the canyon's edge about to fall in; ominous dramatic lighting; JU BON-JIL's silhouette gesturing toward it.",
 "p29":"Two panels. (1 ~55%) JU BON-JIL in dramatic low light delivering the cliffhanger about the chasm and the electric car; NA BAE-UM listening intently. (2 ~45%) the electric car teetering at the chasm edge, a tense final image.",
 "p30":"One panel (~100%). A closing chapter-end composition: the dark chasm with the EV at its edge, NA BAE-UM and JU BON-JIL small silhouettes looking toward it; reserve a black caption band across the very bottom for the next-episode preview. Cinematic Korean webtoon episode-end.",
}
...
DLG = {
 ...
 "p09":[(1,'L','caption','기술애호가 · 최신상'),
        (1,'C','speech','새 AI 모델?\n첫 주에 바로 깔았지!')],
 "p10":[(1,'L','caption','선각수용자 · 고비전'),
        (1,'C','speech','이게 미래야\n남들보다 먼저 잡아야지')],
 "p11":[(1,'C','emph','캐즘 (CHASM)'),
        (1,'C','narr','선각수용자와 실용주의자 사이,\n가장 깊은 균열')],
...
BANDS = {
 ...
 "p08":'사람은 받아들이는 속도에 따라 5부류 · 선각수용자와 실용주의자 사이의 깊은 골이 ‘캐즘’',
 "p11":'캐즘 · 소수 선각수용자에서 다수 대중으로 넘어가는 가장 어려운 구간, 여기서 대부분 죽는다',

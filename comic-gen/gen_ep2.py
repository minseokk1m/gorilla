...
PAGES = {
 ...
 "p07":"Two panels, the corn dialogue (vintage tone continues). (1 ~55%) the first farmer confidently planting the new seed in his plot while a second farmer watches from the fence with crossed arms, curious but cautious. (2 ~45%) autumn: the first farmer's plot visibly taller and fuller; the second farmer now leaning over the fence wide-eyed, a third farmer approaching in the background.",
 ...
 "p15":"One large panel (~100%). The same TALC curve smaller at the top; below it the five archetype members standing on their segment positions, each with ONE short slogan balloon: SIN-SANG '시험해 보자!', BI-JEON '무리보다 앞서 가자!', SIL-SOK '무리와 함께 가자!', JUNG-HAE '버틸 만큼 버텨보자!', MID-EO '절대 안 간다!'. Clean ensemble infographic, webtoon tone.",
 ...
 "p21":"Two panels, AI history part 2. (1 ~55%) 2016: a Go (baduk) board seen from above, a human hand hesitating over a stone, a small screen showing a move number; crowd silhouettes shocked in the background; NO readable text beyond the specified narration. (2 ~45%) ordinary people watching the news amazed on a street screen, but then walking on unchanged, hands in pockets.",
 ...
 "p25":"Two panels, the pivot to investing. (1 ~55%) JU BON-JIL closing the marker cap with a click, shifting tone, warm firm look at the group. (2 ~45%) the whiteboard with ONLY two hand-written phrases connected by an arrow: '마케팅 이론' → '투자에 적용'.",
 "p26":"Two panels, self application. (1 ~55%) NA BAE-UM at the table with his phone showing his old losing stock chart (-56%), applying the two questions; his face rueful but clear-eyed. (2 ~45%) his notebook close-up: ONLY a hand-written two-line checklist: '불연속인가? ✗' / '살 수밖에 없는 이유가 있나? ✗'.",

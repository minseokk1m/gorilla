...
STAGE = "③ 투자와 연결"
SPEAKERS_EXTRA = {'연구원': 'the anonymous young researcher in the lab coat in the foreground (NOT a study-group member)'}
...
PAGES = {
 "p01":f"A cinematic episode-title page, {INK} A big calm gorilla on a stone throne at the top, a chimp holding a shiny new sword on a rock below, tiny monkeys at the bottom; dark jungle; no labels. A clean dark band across the middle for the title text, a thin band at the bottom.",
 ...
 "p03":f"One panel (~100%). A modern AI research lab scene {INK}(no readable text): rows of monitors all showing ONLY abstract green code blocks, anonymous researchers at desks; in the foreground ONE anonymous young researcher (20s, lab coat over a hoodie, glasses, NOT any study-group member) shrugging with a helpless smile toward the viewer, and the speech balloon tail points at THIS researcher; NONE of the study-group cast (no NA BAE-UM, no JU BON-JIL, no red cap) appears in this scene; a small clean label box in the corner: '모든 코드가 CUDA'.",
 ...
 "p09":f"One panel (~100%). A clean-room scene {INK}(no readable text, no logos): engineers in white suits around a huge boxy machine the size of a bus, a thin violet beam inside, a tiny droplet being hit by a laser flash shown in a small round inset; a small clean label box: '극자외선 · EUV'.",
 ...
 "p12":"Two panels. (1 ~55%) JU BON-JIL enjoying the coincidence, hands spread, beside the whiteboard which still shows ONLY the two oval-head silhouettes labeled 'Gordon Moore' and 'Geoffrey Moore' with '무어의 법칙' and '고릴라 게임' beneath; NA BAE-UM smiling. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear; the thought balloon belongs to NA BAE-UM.",
 ...
 "p17":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY the timeline strip from the previous page (a lone chip labeled '스펙 좋은 칩', a full server rack labeled '2026 헬리오스 랙', a wall labeled '그래도 CUDA의 벽'), fair-minded; NA BAE-UM noting silently (NA BAE-UM has NO balloon on this page; do NOT add any extra balloon such as a reply). (2 ~45%) JU BON-JIL tapping the wall icon, firm.",
 ...
 "p19":"Two panels. (1 ~55%) HAN TANG-SU deflating but nodding; JU BON-JIL not unkind; the whiteboard behind shows ONLY the card titled '원칙 5 · 침팬지의 종류' with rows '응용 소프트웨어 침팬지 → 시장 확대 잠재력 있으면 보유' and '지원 기술 침팬지 → 보유하지 않는다'. (2 ~45%) NA BAE-UM's notebook close-up: ONLY these hand-written lines: '침팬지는 스펙이 아니라 생태계에서 진다' / '지원 기술 침팬지는 보유 X'.",
 ...
 "p22":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY the castle-moat sketch with a figure building a plank bridge labeled '호환 도구' and a coin stack labeled '자본', measured; HAN SIL-SOK listening. (2 ~45%) JU BON-JIL adding a small fence around the figure's own yard on the sketch (no text).",
 ...
 "p25":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY the two bars labeled '고릴라 가격' and '원숭이 가격' (the short bar crossed out in red); HAN TANG-SU crestfallen. (2 ~45%) NA BAE-UM's notebook close-up: ONLY these hand-written lines: '원숭이 = 고릴라 흉내의 저가 클론' / '가격 결정권은 고릴라에게만'.",
 ...
 "p28":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY the two stacked blocks labeled '연산' and '메모리' with the note card '병목은 메모리', balanced; NA BAE-UM noting. (2 ~45%) NA BAE-UM's notebook close-up: ONLY these hand-written lines: '고릴라도 균열은 생긴다' / '균열은 다음 시즌의 주제'.",

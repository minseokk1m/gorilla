...
PAGES = {
 ...
 "p16":"Two panels. (1 ~55%) JU BON-JIL noting Google is a different class of challenger with capital and vertical integration; NA BAE-UM noting. (2 ~45%) JU BON-JIL confident close-up.",
 ...
 "p23":"Two panels. (1 ~55%) JU BON-JIL raising a finger for the key bet; NA BAE-UM attentive. (2 ~45%) JU BON-JIL emphatic.",

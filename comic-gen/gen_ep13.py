...
TABLE5 = ("the FIVE-row checklist TABLE titled '초기시장인가, 골짜기를 건넜나' with column headers '초기시장' and '골짜기 건넘', row labels down the left '누가 사나', '참조사례', '완전완비제품', '매출', '시총 대비 매출', and cell texts row by row '선구자만' / '실용주의자도' ; '비전을 말함' / '동료가 쓴다고 함' ; '없음' / '있음' ; '띄엄띄엄' / '가속' ; '매출 없이 시총만' / '매출이 시총을 따라옴'")
...
PAGES = {
 ...
 "p06":f"One panel (~100%). ABSOLUTE RULE: the presenter standing at the whiteboard holding the marker is NA BAE-UM (late-30s, short BLACK hair, NO glasses, charcoal button shirt) and every speech balloon on this page whose speaker is NA BAE-UM has its tail pointing at HIM; JU BON-JIL (grey hair, glasses, navy knit) stands aside or sits and does NOT present (a grey-haired man at the board would be WRONG). The whiteboard shows {TABLE5}, with a far-right column headed '양자' containing check marks aligned with the '초기시장' side for rows 1, 2, 3 and 5 and a small circled '?' for row 4; every cell filled exactly as written; ONLY these labels and marks.",
 "p07":f"Two panels. (1 ~55%) ABSOLUTE RULE: the presenter standing at the whiteboard holding the marker is NA BAE-UM (late-30s, short BLACK hair, NO glasses, charcoal button shirt) and every speech balloon on this page whose speaker is NA BAE-UM has its tail pointing at HIM; JU BON-JIL (grey hair, glasses, navy knit) stands aside or sits and does NOT present (a grey-haired man at the board would be WRONG). NA BAE-UM at the board explaining row four, marker hovering at the circled '?' of the far-right '양자' column; the whiteboard shows {TABLE5} with that '양자' column (checks on rows 1, 2, 3, 5 and a circled '?' on row 4); JU BON-JIL listening from the table. (2 ~45%) JU BON-JIL nodding slowly, one finger raised; plain background.",
 "p08":"Two panels. (1 ~55%) JU BON-JIL writing on a corner of the board ONLY the words '매출은 생기는 중' in a small box (the rest of the board is out of focus, no other readable text); NA BAE-UM nodding. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear; the thought balloon belongs to NA BAE-UM.",
 ...
 "p12":f"Two panels. (1 ~55%) the whiteboard shows {TIMELINE}; JU BON-JIL tapping the rebound and the second peak; HAN TANG-SU brightening. (2 ~45%) the same whiteboard with {TIMELINE}; JU BON-JIL's finger sliding down the long final slide; HAN TANG-SU deflating.",
 "p13":f"Two panels. (1 ~55%) NA BAE-UM standing up with a realization, pointing at the whiteboard which shows {TIMELINE}; JU BON-JIL beside, pleased; NA BAE-UM (black hair, no glasses, charcoal shirt) is the speaker and the balloon tail points at him. (2 ~45%) the notebook close-up: ONLY these hand-written lines: '한마디에 반이 사라지는 가격' / '= 기대가 지탱하는 가격'.",

...
P6CARD = ("a hand-drawn card titled '원칙 6 · 영주와 기사' with three short lines exactly: '가볍게 보유한다' / '시장이 흔들리면 개별 종목을 판다' / '초고성장이 썰물이면 카테고리 전체를 판다'; a small feather icon")
...
LOCK_HS = "ABSOLUTE RULE: the presenter standing at the whiteboard holding the marker is HAN SIL-SOK (40s, BLACK hair, thin metal glasses, neat shirt and knit VEST) and the speech balloon tail points at HIM; JU BON-JIL (grey hair, navy knit) sits at the table and does NOT present (a grey-haired man at the board would be WRONG). "

PAGES = {
 "p01":f"A cinematic episode-title page, {INK} A crowned king on a castle wall at dusk glancing down at an armored knight raising a sword; in the far field tiny peasants; no labels. A clean dark band across the middle for the title text, a thin band at the bottom.",
 ...
 "p04":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY the two office buildings with router boxes, the thick connecting line labeled '같은 표준' and the dotted swap router; HAN SIL-SOK nodding. (2 ~45%) close on HAN SIL-SOK, a knowing look.",
 ...
 "p06":"Two panels. (1 ~55%) JU BON-JIL summarizing the two kings beside the whiteboard which shows ONLY the labels 'Cisco' (with a network-node sketch) and 'Oracle' (with a database-cylinder sketch) and the small label 'SQL'; NA BAE-UM writing. (2 ~45%) the notebook close-up: ONLY these hand-written lines: '영주 = 개방형 시장의 1등' / '점유율은 높지만 옮길 수 있다' / '왕좌가 흔들릴 수 있다'.",
 ...
 "p08":f"One panel (~100%). A kingdom metaphor scene {INK} an armored knight on horseback charging up a ramp toward the castle wall where a nervous king stands; at the bottom of the ramp two small fallen knights; a small clean label box: '기사 · 도전자'; ONLY this label.",
 "p09":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY a small helmet sketch (no words); NA BAE-UM intrigued. (2 ~45%) close on the charging knight's determined face inside the helmet.",
 ...
 "p13":"Two panels. (1 ~55%) JU BON-JIL explaining the serf, hands spread flat, beside the whiteboard which shows ONLY the chart with the blue line labeled '매출' rising and the red line labeled '주가' flat and the small label '똑같은 기능 100개'; HAN SIL-SOK nodding grimly. (2 ~45%) NA BAE-UM's notebook close-up: ONLY these hand-written lines: '소작농 = 차별화 없는 바닥' / '아키텍처도 전환비용도 네트워크도 없음' / '매출이 늘어도 주가는 제자리'.",
 "p14":f"Two panels. (1 ~55%) HAN SIL-SOK (black hair, glasses, knit vest) standing up with his laptop (screen OFF), asking to present, and the balloon tail points at HIM; JU BON-JIL gesturing him to the board. (2 ~45%) {LOCK_HS}HAN SIL-SOK at the whiteboard for the first time, slightly nervous, marker in hand; the board is completely BLANK.",
 "p15":f"One panel (~100%). {LOCK_HS}The whiteboard shows {DRAMCARD}; ONLY these labels.",
 "p16":f"Two panels. (1 ~55%) {LOCK_HS}HAN SIL-SOK explaining row by row beside the whiteboard which shows {DRAMCARD}; NA BAE-UM impressed. (2 ~45%) JU BON-JIL nodding with a pleased look, seated; plain background.",
 "p17":f"Two panels. (1 ~55%) {LOCK_HS}HAN SIL-SOK concluding beside the whiteboard which shows {DRAMCARD} plus a small crown sketch he points at; HAN TANG-SU surprised. (2 ~45%) the notebook close-up: ONLY one hand-written line: '표준 DRAM은 킹덤이다'.",
 ...
 "p20":"Two panels. (1 ~55%) JU BON-JIL explaining beside the whiteboard which shows ONLY the stacked-chip-on-GPU sketch with a padlock and the label '검증에 묶인다', plus a crossed-out crown and a circled gorilla sketch; HAN SIL-SOK nodding slowly. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear; the thought balloon belongs to NA BAE-UM.",
 ...
 "p22":"Two panels. (1 ~55%) NA BAE-UM (black hair, no glasses, charcoal shirt) standing with the season-1 conclusion clicking again, the balloon tail pointing at him; JU BON-JIL pleased; the whiteboard behind is out of focus with no readable text. (2 ~45%) the notebook close-up: ONLY these hand-written lines: '한 회사 안에 두 정글' / '회사가 아니라 카테고리로 본다'.",
 ...
 "p24":f"One panel (~100%). The whiteboard shows {P6CARD}; JU BON-JIL presenting; ONLY these labels.",
 "p25":f"Two panels. (1 ~55%) JU BON-JIL explaining the feather beside the whiteboard which shows {P6CARD}; NA BAE-UM noting. (2 ~45%) JU BON-JIL writing ONLY the word 'WATCH' in a small box on the board corner.",
 "p26":f"Two panels. (1 ~55%) NA BAE-UM asking the difference from gorilla holding; JU BON-JIL answering with a rock-versus-feather gesture beside the whiteboard which shows {P6CARD}. (2 ~45%) the notebook close-up: ONLY these hand-written lines: '고릴라는 바위처럼 들고' / '영주는 깃털처럼 들고' / '영주는 매수 확정이 아니라 관찰'.",

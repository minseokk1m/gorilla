#!/usr/bin/env python3
# 고릴라 헌터스 Ep4 "노르망디 상륙작전" — 교두보 + 완전완비제품 — gpt-image-2 (~30장)
...
PAGES = {
 ...
 "p03":"Two panels, entirely warm SEPIA MONOCHROME 1944 war-memory tone (both panels are the 1944 flashback; NO modern people, NO study room, NO smartphones or tablets anywhere; keep webtoon ink linework). (1 ~60%) a wide Normandy beach; faint scattered arrows spread thin across the whole coast fading away. (2 ~40%) by contrast, all the firepower arrows converge into ONE concentrated point on a single beachhead, a small round corner inset of JU BON-JIL pointing (the ONLY modern element, kept tiny).",
 "p04":"Two panels, entirely warm SEPIA MONOCHROME 1944 (NO modern people, NO study room, NO smartphones or tablets; webtoon ink linework). (1 ~55%) the single beachhead being taken with concentrated force, dramatic. (2 ~45%) a faded image of forces spread thin and failing across the wide beach, contrast.",
 "p05":"Two panels. (1 ~55%) JU BON-JIL firm at the whiteboard pointing at the single converging point; NA BAE-UM noting. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear in this panel; the thought balloon belongs to NA BAE-UM.",
 ...
 "p07":"Two panels, modern IT. (1 ~55%) JU BON-JIL stands at the side presenting (speech balloon tail to JU BON-JIL); the scene he presents: a developer at a desk using an AI copilot screen with code auto-completing; a clean label '개발자 = 교두보'; other office roles (marketing, accounting, design) faintly waiting in the background. (2 ~45%) close on the AI copilot code screen.",
 "p08":"Two panels. (1 ~55%) JU BON-JIL explaining the copilot-beachhead idea, gesturing; NA BAE-UM impressed. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear in this panel; the thought balloon belongs to NA BAE-UM.",
 ...
 "p12":"One panel (~100%). The whiteboard showing TWO concentric circles: the INNER circle labeled '핵심 제품' (an AI copilot engine icon), the OUTER ring labeled '완전완비제품 Whole Product'; JU BON-JIL pointing, HAN SIL-SOK nodding at the outer ring. Clean infographic.",
 ...
 "p21":"Two panels. (1 ~55%) JU BON-JIL making the key investor point, a big magnifying-glass diagnostic icon behind him; NA BAE-UM intent. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear in this panel; the thought balloon belongs to NA BAE-UM.",
 ...
 "p25":"Two panels. (1 ~60%, over-the-shoulder) NA BAE-UM writing a clean summary line in his notebook, JU BON-JIL nodding in the soft background. (2 ~40%) the notebook close-up, a small beachhead-to-markets doodle.",
 ...
 "p27":"Two panels. (1 ~55%) JU BON-JIL turning toward the next idea, a knowing smile; NA BAE-UM curious. (2 ~45%) a small sketch of one bowling pin starting to tip toward the next.",
 ...
 "p29":"Two panels. (1 ~55%) JU BON-JIL in warm light delivering the cliffhanger about bowling pins; NA BAE-UM listening. (2 ~45%) the bowling pins lined up, the first one tipping.",
 "p30":"One panel (~100%). Closing chapter-end: bowling pins with the first tipping into the rest; NA BAE-UM and JU BON-JIL small silhouettes; reserve a black caption band across the very bottom for the next-episode preview.",
}
...
DLG = {
 ...
 "p25":[(1,'C','speech','그러니까 정리하면…'),
        (2,'C','caption','한 교두보 완전 점령 → 참조사례 번짐 → 캐즘 통과')],
 "p26":[(1,'C','think','넓게가 아니라, 깊게 먼저'),
        (2,'C','think','한 점을 확실히')],
 "p27":[(1,'C','speech','한 교두보가 잡히면\n그 다음은 생각보다 빨라'),
        (2,'C','think','연쇄로 번진다고…?')],

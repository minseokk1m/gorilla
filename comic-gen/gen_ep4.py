...
PAGES = {
 ...
 "p04":"Two panels, an aged 1944 war photograph recreated in sepia-brown ink: THERE ARE NO PRESENT-DAY PEOPLE ON THIS PAGE — no mentor, no students, no red cap, no audience, no study room; ONLY anonymous 1944 soldiers on a beach. Entire page brown-and-cream monochrome (no blue, no orange, no green). (1 ~55%) the single beachhead being taken with concentrated force, dramatic. (2 ~45%) a faded image of forces spread thin and failing across the wide beach, contrast.",

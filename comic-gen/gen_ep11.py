...
PAGES = {
 ...
 "p04":"Two panels. (1 ~55%) JU BON-JIL at the head of the table, marker in hand, a knowing dry smile, watching HAN TANG-SU. (2 ~45%) JU BON-JIL turning to the whiteboard which is completely BLANK, uncapping the marker.",
 ...
 "p17":"Two panels. (1 ~55%) NA BAE-UM's notebook close-up: ONLY these hand-written lines: '기대는 공짜' / '채택은 돈'. (2 ~45%) NA BAE-UM tapping his pen on the page, thoughtful; HAN TANG-SU peeking, uneasy.",
 ...
 "p25":"Two panels. (1 ~55%) JU BON-JIL serious, tapping the third bubble; NA BAE-UM sober. (2 ~45%) close-up of NA BAE-UM ONLY (late-30s, plain black hair, NO glasses, charcoal shirt); JU BON-JIL must NOT appear in this panel; the thought balloon belongs to NA BAE-UM.",
 ...
 "p31":"One panel (~100%). A dark moody image: a large old-fashioned thermometer with a red column rising high, and beside it a small stock-chart silhouette (bare line, no text); anticipatory tone; keep webtoon ink style.",
